    ...
    return (
        ...
        <div className="w-full flex flex-col items-center justify-center gap-4">
            <div className="ml-1 md:ml-0 w-full md:w-[90%] flex justify-center items-center md:justify-start md:items-start md:gap-4" >
                <div className="flex cursor-pointer gap-1 items-center bg-gray-50 py-2 pl-1 md:px-2 group" onClick={()=>handlePostLike(post)}>
                ...
                <div className="flex cursor-pointer gap-1 items-center bg-gray-50 py-2 px-1 md:px-2">
